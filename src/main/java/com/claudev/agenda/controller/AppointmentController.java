...
public class AppointmentController {
    ...
    public ResponseEntity<List<AppointmentResponseDTO>> getCustomerAppointments (Authentication authentication) {
        ...
        List<AppointmentResponseDTO> responseDTOList = appointmentService.getAppointmentByCustomer(customer).stream().map(appointmentMapper::toResponseDTO).toList();
    ...
    public ResponseEntity<List<AppointmentResponseDTO>> getProfessionalAppointments (Authentication authentication) {
        ...
        List<AppointmentResponseDTO> responseDTOList = appointmentService.getAppointmentByProfessional(professional).stream().map(appointmentMapper::toResponseDTO).toList();
